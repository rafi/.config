...
set -g status-right "#[fg=colour234]#[fg=colour238,bg=colour234] #(kubectl config current-context 2>/dev/null) #[fg=colour235]#[fg=colour239,bg=colour235] #(uptime | sed 's/.*load average[^0-9]*//;s/,//g') #[fg=colour236]#[fg=colour241,bg=colour236] #(batt) #[fg=colour237]#[fg=colour243,bg=colour237] %H:%M #[fg=colour238]#[fg=colour244,bg=colour238] #h "
