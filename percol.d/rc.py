...
#    "C-d" : lambda percol: percol.command.delete_forward_char(),
    "C-w" : lambda percol: percol.command.kill_end_of_line(),
    ...
    "M-d" : lambda percol: percol.command.select_next_page(),
    "M-u" : lambda percol: percol.command.select_previous_page(),
    "C-<" : lambda percol: percol.command.select_top(),
    "C->" : lambda percol: percol.command.select_bottom(),
