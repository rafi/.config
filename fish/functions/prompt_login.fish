# /opt/homebrew/share/fish/functions/prompt_login.fish
function prompt_login --description 'display user name for the prompt'
	...
	echo -n -s (set_color $fish_color_user) "$USER" (set_color $__rafi_git_prompt_color_atsign) @ (set_color $color_host) (prompt_hostname) (set_color normal)
end
