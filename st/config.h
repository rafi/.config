 ...
 */
static char font[] = "PragmataPro:style=Regular:pixelsize=18:antialias=true:hintstyle=3:autohint=true";
 ...
 */
static char shell[] = "/opt/local/bin/bash";
